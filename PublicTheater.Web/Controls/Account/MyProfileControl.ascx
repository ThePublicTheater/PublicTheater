...
<div id="registerControl">
    ...
    <div class="row-fluid">
        ...
        <div class="small-12 medium-12 large-12">
            ...
            <asp:HiddenField ClientIDMode="Static" ID="Mail2Forum" runat="server" />
            <asp:HiddenField ClientIDMode="Static" ID="Mail2Utr" runat="server" />
            <asp:HiddenField ClientIDMode="Static" ID="Mail2Weekly"  runat="server" />
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    var Mail2ForumEl = document.getElementById('<%= Mail2Forum.ClientID%>');
                    var Mail2UtrEl = document.getElementById('<%= Mail2Utr.ClientID%>');
                    var Mail2WeeklyEl = document.getElementById('<%= Mail2Weekly.ClientID%>');
                    window.Mail2 = function() {
                        ...
                        Mail2ForumEl.value = $("#Mail2ForumOption").prop('checked');
                        Mail2UtrEl.value = $("#Mail2UtrOption").prop('checked');
                        Mail2WeeklyEl.value = $("#Mail2WeeklyOption").prop('checked');
                    };
                });
            </script>
        </div>

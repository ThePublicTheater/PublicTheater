<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PackageList.ascx.cs" Inherits="PublicTheater.Web.Controls.Subscriptions.package.PackageList" %>
...
<asp:Repeater runat="server" ID="rptPackages">
    ...
    <ItemTemplate>
        ...
        <div class="packageListItemWrapper row-fluid fwidth">
            <div class="span12">
                <div class="span8">
                    <h3><asp:Literal runat="server" ID="ltrPackageTitle" /></h3>
                ...
                <asp:Panel runat="server" ID="pnlSubscribeArea" CssClass="subscribeArea packageSubscribe">
                    ...
                    <div class="buttonWrapper">
                        ...
                        <asp:HyperLink ID="lnkPurchaseVoucher" runat="server" Text="Purchase Voucher" CssClass="btn" Visible="false" />
                    </div>
                </asp:Panel>
            </div>

...
<script type="text/javascript">
    ...
    function addMonthToUrl(month) {
        try {
            window.history.replaceState(window.history.state, month, UpdateQueryString("month", month, window.location.href));
        } catch (e) {
...
<asp:Panel ID="pnlCalendarFilter" CssClass="calFilters" runat="server">
    <asp:HiddenField ID="ThemePerformanceIds" runat="server" ClientIDMode="Static" />

    <asp:HiddenField ID="SelectedTheme" runat="server" ClientIDMode="Static" />

<%@ Page Title="" Language="C#" MasterPageFile="~/Views/MasterPages/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="ArchivedPlayDetail.aspx.cs" Inherits="PublicTheater.Web.Views.Pages.ArchivedPlayDetail" %>
<%@ Import Namespace="Adage.Common.ExtensionMethods.Generic" %>
<%@ Import Namespace="EPiServer.Core" %>
<%@ Import Namespace="PublicTheater.Custom.Episerver.Pages" %>

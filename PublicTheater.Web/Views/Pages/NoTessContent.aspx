<%@ Page Language="C#" MasterPageFile="~/Views/MasterPages/NoTessMaster.Master" AutoEventWireup="true"
    CodeBehind="NoTessContent.aspx.cs" Inherits="PublicTheater.Web.Views.Pages.NoTessContent" %>
        ...
        <div class="generalContentWrapper">
            <div class="row">
                <div class="large-9 medium-8 small-12">
                    <EPiServer:Property ID="Property2" runat="server" PropertyName="MainBody" CssClass="block noHeight MainBody">
                    </EPiServer:Property>
                    <EPiServer:Property ID="Property1" runat="server" PropertyName="Underbody"  DisplayMissingMessage="False">
                    </EPiServer:Property>

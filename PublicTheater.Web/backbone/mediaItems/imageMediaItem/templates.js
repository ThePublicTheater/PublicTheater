...
function program1(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "\" alt=\"";
  if (stack1 = helpers.MediaItemTitle) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.MediaItemTitle; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "\"></img></li>\r\n			  ";
  return buffer;
  }
  ...
  stack1 = helpers.each.call(depth0, depth0.relatedMediaItems, {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\r\n		  </ul>\r\n\r\n		  <span id=\"slider-prev\" class=\"prev\"></span>\r\n		  <span id=\"slider-next\" class=\"next\"></span>\r\n    </div>\r\n	</div>\r\n	<div id=\"rightPanel\" class=\"large-4 medium-4 small-12\">\r\n		<div class=\"rightPanelTopBar\">\r\n			<span class=\"closePlayerButton\">X</span>\r\n		</div>\r\n		<div class=\"mediaItemInformation\">\r\n            <span class=\"title\">";
  if (stack1 = helpers.title) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.title; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "</span>\r\n            <span class=\"subtitle\">";

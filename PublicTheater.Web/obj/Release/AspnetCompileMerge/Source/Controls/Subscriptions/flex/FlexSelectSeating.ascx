<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FlexSelectSeating.ascx.cs"
    Inherits="TheaterTemplate.Web.Controls.Subscriptions.FlexControls.FlexSelectSeating" %>
            ...
            <div id="packageDisplayContainer">
                <div id="packageDisplay">
                        ...
                        <div class="subsFlexHeader">
                            <div class="flexGuidelines">
                                ...
                                <div class="flexDescHeader">
                                    <span class="plays"><asp:Literal runat="server" ID="ltrAmountPlays" /></span> Plays <small>(<asp:Literal
                                        runat="server" ID="ltrMinPerformances" />
                                        play minimum)</small>
                                    </div>
                            </div>
                        </div>
                    ...
                    <div class="clearfix flexBtnContainer">
                        ...
                        <asp:LinkButton Text="Add To Cart" runat="server" ID="btnAddToCart" CssClass="btn btnStandOut" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div id="packageDisplay">
                    ...
                    <div class="packageArea">
                        <div class="flexGuidelines">
                            <h3>
                                My
                                <asp:Literal runat="server" ID="ltrPackageInformation" /></h3>
                            <p><span class="plays">
                                <asp:Literal runat="server" ID="ltrAmountPlays" /></span> Plays <small>(<asp:Literal
                                    runat="server" ID="ltrMinPerformances" />
                                    play minimum)</small></p>
                        </div>
                        <div class="miniCart">
                            <asp:Repeater runat="server" ID="rptPerformances">
                                <HeaderTemplate>
                    ...
                    <div class="continueBtn clearfix">
                        <asp:LinkButton Text="Add To Cart" runat="server" ID="btnAddToCart" CssClass="btn btn-primary pull-right" />
                    </div>
                </div>
            </div>
            <div id="selectSeatingArea">

...
function (Backbone, cfsConfig) {
    ...
    var CFSApp = CFSView.extend({
        ...
        loadFriendLogin: function () {
            console.log("loading friend login, under Construction");
        ...
        loadFriendSelect: function () {
            console.log("loading friend select, under Construction")
        ...
        loadFriendManager: function () {
            console.log("loading friend manager, under Construction");
        ...
        loadReserveControl: function () {
            ...
            var path = cfsConfig.makeCFSUrl("reserveControl/reserveControl");
            require([path], _(function (CFSReserveControl) {
        ...
        loadFullSubControl: _(function () {
            console.log("CFS: Loading Full Subscription Control, under Construction");
            //head.js(
        ...
        loadExchangeControl: _(function () {
            ...
            //    }).bind(this)
            //);
            var path = cfsConfig.makeCFSUrl("exchange/exchangeControl");
            require([path], _(function (ExchangeControl) {
        ...
        loadCalendarControl: _(function () {
            ...
            var path = cfsConfig.makeCFSUrl("calendar/calendarControl");
            require([path], _(function (CalendarControl) {
        ...
        loadMobileCalendar: _(function () {
            ...
            //    }).bind(this)
            //);
            var path = cfsConfig.makeCFSUrl("calendar/mobileCalendar");
            require([path], _(function (MobileCalendar) {

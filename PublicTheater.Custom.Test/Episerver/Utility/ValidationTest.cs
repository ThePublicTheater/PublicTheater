...
namespace PublicTheater.Custom.Test.Episerver.Utility
{
    ...
    public class ValidationTest
    {
        ...
        {
            var isEmail = Validation.IsEmail("abcd123@abcd123.com");
            Assert.AreEqual(true, isEmail);

            isEmail = Validation.IsEmail("Testadagetechnologies.com");
